...
using BoilerPlate.Application.Features.Events.Commands.DeleteEvent;
using BoilerPlate.Application.UnitTests.Mocks;
...
namespace BoilerPlate.Application.UnitTests.Events.Commands
{
